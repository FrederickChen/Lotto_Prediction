...
dataframe = pandas.read_csv('lt.csv',header=None, engine='python')
...
for i in range(trainPredictPlot.shape[1]):
        plt.plot(bk_dataset[-100:,i])
        plt.plot(trainPredictPlot[-100:,i])
        plt.show()
